...
const expectedColumns = {
  users: [
    ...
    { name: 'CHECK', definition: "CONSTRAINT users_role_check CHECK (role IN ('user', 'admin'))", constraintName: 'users_role_check' },
  ],
  assignments: [
    { name: 'id', definition: 'INT AUTO_INCREMENT PRIMARY KEY' },
    ...
    { name: 'assignment_mode', definition: "ENUM('TextBox', 'BBox') NOT NULL DEFAULT 'TextBox'" },
    { name: 'is_score', definition: 'BOOLEAN NOT NULL DEFAULT 1' },
    { name: 'is_ai_use', definition: 'BOOLEAN NOT NULL DEFAULT 1' },
    { name: 'UNIQUE', definition: 'UNIQUE KEY title_deadline_unique (title, deadline)', constraintName: 'title_deadline_unique' },
  ],
  assignment_user: [
    ...
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (assignment_id) REFERENCES assignments(id) ON DELETE CASCADE', constraintName: 'fk_assignment_user_assignment' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE', constraintName: 'fk_assignment_user_user' },
  ],
  questions: [
    { name: 'id', definition: 'INT AUTO_INCREMENT PRIMARY KEY' },
    { name: 'assignment_id', definition: 'INT' },
    { name: 'image', definition: 'VARCHAR(255) NOT NULL' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (assignment_id) REFERENCES assignments(id) ON DELETE CASCADE', constraintName: 'fk_questions_assignment' },
  ],
  question_responses: [
    { name: 'id', definition: 'INT AUTO_INCREMENT PRIMARY KEY' },
    ...
    { name: 'UNIQUE', definition: 'UNIQUE KEY question_user_unique (question_id, user_id)', constraintName: 'question_user_unique' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (question_id) REFERENCES questions(id)', constraintName: 'fk_question_responses_question' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (user_id) REFERENCES users(id)', constraintName: 'fk_question_responses_user' },
  ],
  posts: [
    { name: 'id', definition: 'INT AUTO_INCREMENT PRIMARY KEY' },
    { name: 'user_id', definition: 'INT' },
    ...
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE', constraintName: 'fk_posts_user' },
  ],
  comments: [
    { name: 'id', definition: 'INT AUTO_INCREMENT PRIMARY KEY' },
    ...
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (post_id) REFERENCES posts(id) ON DELETE CASCADE', constraintName: 'fk_comments_post' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE', constraintName: 'fk_comments_user' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (parent_comment_id) REFERENCES comments(id) ON DELETE SET NULL', constraintName: 'fk_comments_parent' },
  ],
  attachments: [
    { name: 'id', definition: 'INT AUTO_INCREMENT PRIMARY KEY' },
    { name: 'post_id', definition: 'INT' },
    ...
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (post_id) REFERENCES posts(id) ON DELETE CASCADE', constraintName: 'fk_attachments_post' },
  ],
  canvas_info: [
    { name: 'id', definition: 'INT AUTO_INCREMENT PRIMARY KEY' },
    { name: 'assignment_id', definition: 'INT' },
    ...
    { name: 'user_id', definition: 'INT' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (assignment_id) REFERENCES assignments(id) ON DELETE CASCADE', constraintName: 'fk_canvas_info_assignment' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE', constraintName: 'fk_canvas_info_user' },
  ],
  squares_info: [
    { name: 'id', definition: 'INT AUTO_INCREMENT PRIMARY KEY' },
    ...
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (question_id) REFERENCES questions(id) ON DELETE CASCADE', constraintName: 'fk_squares_info_question' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (canvas_id) REFERENCES canvas_info(id) ON DELETE CASCADE', constraintName: 'fk_squares_info_canvas' },
    { name: 'FOREIGN KEY', definition: 'FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE', constraintName: 'fk_squares_info_user' },
  ],
};
  ...
  try {
    ...
    for (const table in createTablesSQL) {
      ...
      for (const col of expectedCols) {
        if (col.name === 'CONSTRAINT' || col.name === 'CHECK' || col.name === 'UNIQUE' || col.name === 'PRIMARY KEY' || col.name === 'FOREIGN KEY') {
          // 제약 조건 추가
          ...
          if (!constraintName) {
            ...
            const constraintNameMatch = constraintDefinition.match(/CONSTRAINT\s+(\w+)/i);
            constraintName = constraintNameMatch ? constraintNameMatch[1] : null;
          }

          if (!constraintName) {
            // 제약 조건 이름이 없는 경우 정의 전체를 해시하여 이름 생성
            constraintName = `constraint_${Buffer.from(constraintDefinition).toString('hex').slice(0, 16)}`;
          }
