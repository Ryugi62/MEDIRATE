...
const expectedColumns = {
  users: [
    ...
    { name: 'PRIMARY KEY', definition: 'PRIMARY KEY (id)', constraintName: 'PRIMARY' },
  ...
  assignment_user: [
    ...
    { name: 'PRIMARY KEY', definition: 'PRIMARY KEY (assignment_id, user_id)', constraintName: 'PRIMARY' },
  ...
  try {
    ...
    for (const table in createTablesSQL) {
      ...
      for (const col of expectedCols) {
        if (col.name === 'PRIMARY KEY' || col.name === 'UNIQUE' || col.name === 'CHECK' || col.name === 'FOREIGN KEY') {
          // 제약 조건 추가
